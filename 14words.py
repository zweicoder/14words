...
# We will use pattern of adj adj noun verb adj adj noun
# E.g. quick brown horse and big fat pig eat healthy green cabbages with red carrot
# which has order 42, more than 2^160 (== 16^40) which has order 48 for Ethereum addresses
pattern = [adjs, adjs, nouns] + [adjs, adjs, nouns] + [verbs] + [adjs, adjs, nouns] + [adjs, nouns]
pattern_len = [len(l) for l in pattern]


# addr = '0x667ABBa73ABfCC9321516b10CBb486F29a855Ae8'
